...
const zonedTime=(v,timeZone,label)=>v?new Intl.DateTimeFormat('zh-CN',{timeZone,month:'2-digit',day:'2-digit',hour:'2-digit',minute:'2-digit',hourCycle:'h23'}).format(new Date(v))+' '+label:'时间待核';
const time=v=>zonedTime(v,'Asia/Tokyo','JST');
const chinaTime=v=>zonedTime(v,'Asia/Shanghai','CST');
